<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.Random,java.sql.Statement,java.util.Scanner" %>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
      ...
      <li><a href="apply.jsp"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 control">
                                        ...
                                        <a href="apply.jsp" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Sign Up Here
                                        </a>
                                        </div>
                                    </div>
